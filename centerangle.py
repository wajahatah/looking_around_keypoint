""" Calculate the angle between head keypoint and center point 
between ears keypoints and compare the angle with the visual field angle.
If angle doesn't lie with in the visual field predict looking around. 
Visual Field is dynamic, change with the position of student """
